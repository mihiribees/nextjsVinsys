            ...
            <form onSubmit={handleOnClick}>
                <ul class="common-from d-flex">
                    ...
                    <li>
                        ...
                        <input onChange={handleChange} className="alpha-input" type="text" placeholder="Last Name" id="l-name" name="last_name" required/>
                    </li>
                    <li>
                    ...
                    <li class="w-100">
                        ...
                        <select onChange={handleChange} name="services"  id="services" required>
                            <option value="">Select Service</option>  
                            <option value="Ready to go Digital Learning Content">Ready to go Digital Learning Content</option>  
                            <option value="Learning Management Platforms">Learning Management Platforms</option>  
                            <option value="Custom Content Development">Custom Content Development</option>  
                    ...
                    <li class="w-100 d-flex justify-content-end btn-wrapper">    
                        ...
                        <div class="links">
                            ...
                            <br/>
                            <p className="errorMsg mt-60">{errormessage}</p>
                        </div>
...
export default DigiRequestQuoteForm
